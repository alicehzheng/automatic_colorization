...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--loadSize', type=int, default=384, help='scale images to this size')
        ...
        parser.add_argument('--name', type=str, default='siggraph_caffemodel', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='./colorization_pytorch/checkpoints', help='models are saved here') #modified
        ...
        parser.add_argument('--display_winsize', type=int, default=384, help='display window size')
        ...
        parser.add_argument('--mask_cent', type=float, default=0, help='mask centering factor')
        ...
        parser.add_argument('--load_model', action='store_false', help='load the latest model')  #modified
